...
// 	protoc        v4.23.4
// source: pkg/protocal/raw/publish_list.proto
...
func (x *DouyinPublishListRequest) Reset() {
	*x = DouyinPublishListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_protocal_raw_publish_list_proto_msgTypes[0]
...
func (*DouyinPublishListRequest) Descriptor() ([]byte, []int) {
	return file_pkg_protocal_raw_publish_list_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinPublishListResponse) Reset() {
	*x = DouyinPublishListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_protocal_raw_publish_list_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListResponse) Descriptor() ([]byte, []int) {
	return file_pkg_protocal_raw_publish_list_proto_rawDescGZIP(), []int{1}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_protocal_raw_publish_list_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_pkg_protocal_raw_publish_list_proto_rawDescGZIP(), []int{2}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_protocal_raw_publish_list_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_pkg_protocal_raw_publish_list_proto_rawDescGZIP(), []int{3}
}
...
var File_pkg_protocal_raw_publish_list_proto protoreflect.FileDescriptor

var file_pkg_protocal_raw_publish_list_proto_rawDesc = []byte{
	0x0a, 0x23, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x61, 0x6c, 0x2f, 0x72,
	0x61, 0x77, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x2e,
	...
	0x4c, 0x69, 0x73, 0x74, 0x22, 0xfd, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e,
	...
	0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x63, 0x6f, 0x72,
	0x65,
}

var (
	file_pkg_protocal_raw_publish_list_proto_rawDescOnce sync.Once
	file_pkg_protocal_raw_publish_list_proto_rawDescData = file_pkg_protocal_raw_publish_list_proto_rawDesc
)

func file_pkg_protocal_raw_publish_list_proto_rawDescGZIP() []byte {
	file_pkg_protocal_raw_publish_list_proto_rawDescOnce.Do(func() {
		file_pkg_protocal_raw_publish_list_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_protocal_raw_publish_list_proto_rawDescData)
	})
	return file_pkg_protocal_raw_publish_list_proto_rawDescData
}

var file_pkg_protocal_raw_publish_list_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_protocal_raw_publish_list_proto_goTypes = []interface{}{
...
var file_pkg_protocal_raw_publish_list_proto_depIdxs = []int32{
...
func init() { file_pkg_protocal_raw_publish_list_proto_init() }
func file_pkg_protocal_raw_publish_list_proto_init() {
	if File_pkg_protocal_raw_publish_list_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_protocal_raw_publish_list_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_protocal_raw_publish_list_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_protocal_raw_publish_list_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_protocal_raw_publish_list_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_protocal_raw_publish_list_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_protocal_raw_publish_list_proto_goTypes,
		DependencyIndexes: file_pkg_protocal_raw_publish_list_proto_depIdxs,
		MessageInfos:      file_pkg_protocal_raw_publish_list_proto_msgTypes,
	}.Build()
	File_pkg_protocal_raw_publish_list_proto = out.File
	file_pkg_protocal_raw_publish_list_proto_rawDesc = nil
	file_pkg_protocal_raw_publish_list_proto_goTypes = nil
	file_pkg_protocal_raw_publish_list_proto_depIdxs = nil
}
